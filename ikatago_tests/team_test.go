...
const (
	IKATAGO_CLUSTER_TEAM_COLLECTION_TEAM                 = "team"
	IKATAGO_CLUSTER_TEAM_CHARGE_RECORD_COLLECTION_TEAM   = "team_charge_record"
	IKATAGO_CLUSTER_TEAM_TRANSFER_RECORD_COLLECTION_TEAM = "team_transfer_record"
	DBNAME_TEST_TEAM                                     = "ikatago_test"
)

func TestEnsureIndicesTeam(t *testing.T) {

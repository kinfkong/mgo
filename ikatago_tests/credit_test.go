...
const (
	IKATAGO_CLUSTER_USER_CREDITS_COLLECTION_CREDIT = "user_credits"
	DBNAME_TEST_CREDIT                             = "ikatago_test"
)

func TestEnsureIndexCredit(t *testing.T) {
...
func TestEnsureIndicesCredit(t *testing.T) {
	session := getSession(t)
	defer session.Close()
